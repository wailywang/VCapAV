...
class TrainDataset_ASVspoof5_offset_codec(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        utt, ori_path, aac_path, mp3_path, ogg_path = self.wav_scp[idx]
        file_path = random.choice([ori_path, aac_path, mp3_path, ogg_path])
...
class DevDataset_ASVspoof5_offset(Dataset):
    def __init__(self, args, wav_scp, utt2label:dict,
                 fs=16000, preemph=False,
                 is_aug=False, aug_rate:float=2/3, snr_range=None, noise_dict=None,
                 is_specaug=False, vad=False, speed=False, reverb=False):
...
if __name__ == "__main__":
    ...
    ## training data
    utt2wav = [line.split() for line in open(f'/Work29/wwm1995/SMIIP/Anti_Spoof/ASVspoof5/data/train/wav.scp')]
    utt2label = [line.split() for line in open(f'/Work29/wwm1995/SMIIP/Anti_Spoof/ASVspoof5/data/train/utt2label')]
